...
class Helper
{
     ...
     * @return mixed
     */
    public static function arrayGet(array $array, $key, mixed $default = null)
    {
        if (is_null($key)) {
            return $array;
        }
     ...
     * @param  string|null $key
     */
    public static function arrayIsset(array $array, $key): bool
    {
        if (is_null($key)) {
            return false;
        }
     ...
     */
    public static function arraySet(mixed &$target, $key, mixed $value, $overwrite = true): array
    {
        if (is_null($key)) {
            if ($overwrite) {
     ...
     * @return mixed
     */
    public static function arrayUnset(mixed &$target, $key)
    {
        if (!is_array($target)) {
            return $target;
        }
